...
| Data Olympus | Partial | Typed Markdown with frontmatter, stable ids, tiers, links, and generated indexes and outlines; imports of `CLAUDE.md`, `AGENTS.md`, `.cursorrules`, ADR and OKF material land as draft records. | Structure is authored and reviewed, not inferred from raw captures; there is no automatic classification or linking. |
