...
| GotSaeng OS | Built-in | Deterministic classification into project, decision, research, weekly review, chat export, and template note types, plus extraction into facts, decisions, actions, risks, assumptions, questions, and insights. | Rule-based extraction and classification, not semantic or LLM-inferred; quality depends on source note structure. |
