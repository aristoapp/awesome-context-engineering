...
| GotSaeng OS | Built-in in files | Generated Markdown/JSON reports, an Obsidian Report Hub view with source-note buttons and backlinks, and provenance/confidence/contradiction-candidate review queues; corrections happen by editing source notes and recompiling. | No hosted dashboard; review is file- and Obsidian-based, and heuristic outputs are review queues, not correctness judgments. |
