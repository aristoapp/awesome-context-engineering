...
| Data Olympus | Partial | Markdown and git history are directly inspectable; CLI and MCP expose list, outline, pending-review, audit and health views. | No web knowledge editor or dashboard; inspection happens in git tooling, the CLI or the agent. |
