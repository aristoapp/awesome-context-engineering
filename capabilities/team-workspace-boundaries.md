...
| Data Olympus | Partial | Tiers (universal, stack, project, component) and workspace/component paths scope guidance; git and service deployment provide sharing. | No team-membership or per-document permission product; access control is external to the service. |
