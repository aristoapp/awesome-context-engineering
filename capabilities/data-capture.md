...
| Data Olympus | Built-in + API | Markdown authoring, corpus import of rule files, ADR and OKF material, and agent-proposed memories or edits through MCP, CLI or REST. | No passive connectors for chats, email, calendars or SaaS applications; every capture is a deliberate import or proposal. |
