...
| [GotSaeng OS](../solutions/gotsaeng-os.md) | Strong | Strong | Partial / handoff only | A selected vault and project name scope each compile, and `TEAM_MEMORY.md` supports handoff; shared storage, permissions, concurrent editing, sync, and approvals are external. |
