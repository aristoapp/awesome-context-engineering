...
| [MemoryPlugin](../solutions/memoryplugin.md) | Strong | Strong | Partial | Buckets scope personal and project contexts; shared buckets add per-person permissions and attribution, but there is no org workspace or admin product. |
