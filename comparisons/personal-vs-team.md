...
| [Stigmergy](../solutions/stigmergy.md) | Not primary fit | Possible | Strong / operational | Team is the unit of adoption: audience scopes enforced before retrieval, Slack answers scoped to caller or channel, steward-approved entity pages. Identities are a JSON file in the repo, so no SSO. |
...
| [obsidian-wiki](../solutions/obsidian-wiki.md) | Strong | Strong | Partial / operational | Named vault profiles and project pages separate contexts, but shared-vault sync, concurrent editing, permissions, and approvals are external. |
