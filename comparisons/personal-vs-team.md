...
| [taOSmd](../solutions/taosmd.md) | Strong | Strong | Partial / operational | Per-agent isolated indexes via an agent registry separate scopes, but there is no enforced multi-user RBAC; team isolation is per-agent, not role-based. |
