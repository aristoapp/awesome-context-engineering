...
| [Hermes Agent + Obsidian + Honcho](../solutions/hermes-obsidian-honcho.md) | Yes, fully local — Obsidian vault + Honcho self-hosted + Hermes local gateway | No cloud dependency for core functions | Fully local second brain with agent memory, email, and inspectable Markdown | Higher setup burden; you own integration and operations of multiple components. |
