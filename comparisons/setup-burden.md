...
| [MemoryPlugin](../solutions/memoryplugin.md) | Install the browser extension (or connect an MCP client via OAuth), sign in, and optionally import chat-history exports. | Storage, indexing, hosted retrieval, MCP server hosting, background sync, and Smart Memory categorization. Paid product. |
