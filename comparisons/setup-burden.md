...
| [GotSaeng OS](../solutions/gotsaeng-os.md) | Run the published CLI or install the desktop Obsidian plugin, choose the vault/output/project, and review generated reports. | Easy to start, but users own source quality, backups/sync, heuristic review, and manual delivery of context to AI tools. |
