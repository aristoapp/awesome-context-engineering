...
| [Backscroll](https://backscroll.xyz) | Hosted app that imports ChatGPT, Claude, and Gemini export history and makes every past prompt, answer, and idea searchable. | Emerging Collect/Use-layer candidate for the narrow case of AI-chat-history-as-second-brain; single-source import today (chat exports, not live connectors), so Organize/Evolve/Govern depth still needs source-backed evaluation before a full profile. |
