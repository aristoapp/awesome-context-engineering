...
| [Mindola](https://mindola.ai) | Hosted personal AI lens that ingests a person's website, PDFs, and videos into a source-grounded knowledge base, exposed as a public page and a remote [MCP server](https://github.com/Mindola-ai/mcp-server) that MCP-compatible AI clients can query with citations. | Emerging Use-layer candidate; hosted, individual scope, with a claimable-lens governance surface; setup burden and retrieval model still need source-backed evaluation before a full profile. |
