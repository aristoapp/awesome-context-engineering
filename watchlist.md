...
| [BundleDex](https://bundledex.net) / [Awesome OKF](https://github.com/McClawdDigital/awesome-okf) | Curated directory of 240+ OKF (Open Knowledge Format) knowledge bundles — structured, portable Markdown knowledge packages with YAML frontmatter that AI agents can consume natively. | Candidate for Organize-stage resource discovery. Not a memory system itself — it's a registry of pre-built knowledge packages that second-brain systems can ingest. |
