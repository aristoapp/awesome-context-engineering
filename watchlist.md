...
| [Orkas](https://github.com/Orkas-AI/Orkas) | Open-source, local-first desktop AI workspace where specialist agents can retain private skills and memory and improve through reflection. | Emerging Evolve/Use candidate; official sources establish a local workspace and agent evolution, but collection, knowledge organization, portability, and governance still need source-backed evaluation before a full profile. |
